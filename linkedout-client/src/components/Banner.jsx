...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        <h1 className='text-5cl font-bold text-primary mb-3'>Find your <span className='text-blue'>new job</span> today</h1>
        ...
        <form>
            <div className='flex justify-start md:flex-row flex col md:gap-0 gap-4'>
                ...
                <button type='submit' className='bg-black py-2 px-8 text-white md:rounded-s-none rounded'>Search</button>
            </div>
        </form>
    </div>
  )
